...
export const Footer: React.FC = () => (
  <div className="w-full bg-custom-background-200 pt-20">
    <div className="mx-auto md:max-w-[640px] md:text-center px-4">
      <h5 className="font-paragraph text-custom-text-100 text-[18px]">what’s Next ?</h5>
      <h2 className="text-custom-text-100 font-heading text-[46px] mt-[5px] mb-[8px] font-bold">Get In Touch</h2>
      <p className="text-custom-text-200 font-paragraph text-base">
        I’m currently looking for any new opportunities, my inbox is always open. Whether you have a question or just
    ...
    <div className="flex md:justify-between justify-center items-center md:p-12 py-6">
      <Link href={"/"}>
        <div className="hidden md:flex items-center hover:cursor-pointer">
          ...
          <p className="text-custom-text-200 font-paragraph text-base px-2">Lakhan’s Folio</p>
        </div>
      </Link>
