...
const ContactMeForm = () => (
  <div className="bg-[#235FE7] py-8 px-20 rounded-3xl w-[100%]">
    ...
    <label className="text-white text-base font-paragraph block mt-4">Email</label>
    <input
      type="text"
      name="email"
    ...
    <label className="text-white text-base font-paragraph block mt-4">Phone</label>
    <input
      type="text"
      name="phone"
    ...
    <label className="text-white text-base font-paragraph block mt-4">Message</label>
    <textarea
      rows={5}
      name="message"
