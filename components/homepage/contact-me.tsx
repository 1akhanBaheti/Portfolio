...
export const ContactMe = () => {
  return (
    <div className="flex flex-col items-center h-full w-full xl:max-w-7xl mx-auto ">
      <h1 className="font-heading font-bold text-3xl text-custom-text-100 text-left w-full">
        Contact Me
      </h1>
      <div className="flex py-12 gap-x-10">
        <div className="relative flex flex-col bg-custom-primary-200 w-fit px-6 py-8 rounded-3xl max-w-[40%]">
          <h3 className="text-white font-raleway font-semibold text-3xl text-custom-text-100">
            Say Hello!
          </h3>
          ...
          <h4 className="text-white font-raleway font-semibold text-xl text-custom-text-100 my-6">
            Email
          </h4>
          <a
            href="mailto:"
            className="text-white font-paragraph text-base hover:underline"
          >
