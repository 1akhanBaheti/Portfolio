  ...
  return (
    <>
      ...
      <Image
        src={GridLight}
        alt="background"
        className="fixed h-[100vh] w-[100vw] object-cover -z-20 opacity-30 inset-0 dark:hidden"
      />
      <div className="min-h-[90vh] pt-20 h-fit flex items-center my-auto md:max-w-4xl lg:max-w-5xl xl:max-w-7xl mx-auto overflow-x-hidden hide-scrollbar">
        <div className="flex flex-col">
          ...
          <h6 className="font-heading text-custom-primary-200 font-extrabold tracking-[0.2px] lg:text-[70px] sm:text-[50px] text-[38px] lg:leading-[70px] sm:leading-[50px] leading-[42px] mt-[8px] md:max-w-2xl lg:max-w-3xl xl:max-w-2xl md:text-center px-4 mx-auto">
            I build things for web & mobile.
          </h6>
          <p className="text-custom-text-200 font-paragraph tracking- font-medium text-base mt-[25px] max-w-full md:max-w-2xl lg:max-w-4xl md:text-center px-4 mx-auto">
            I’m a 21 year old undergraduate computer science student from India pursuing B.Tech at the SSIPMT, Raipur.
            I’m passionate about building apps and learning new technologies. Currently, I’m focused on shipping{" "}
            <Link
              target="_blank"
