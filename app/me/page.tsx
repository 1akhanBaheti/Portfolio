...
export default function AboutMe() {
  return (
    <div className="min-h-[100vh] h-fit flex flex-col mt-20 bg-custom-background-100 max-w-7xl mx-auto">
      <h1 className="font-heading text-4xl">About me</h1>
      <div className="relative flex">
        <div className="mr-10 pt-12">
          <h2 className="font-heading text-xl">Introduction:</h2>
          ...
          <h2 className="font-heading text-xl mt-6">
          ...
          <ol className="text-custom-text-200 font-paragraph tracking text-base pt-2 list-decimal pl-4 marker:text-custom-text-100">
            <li>
              <ul className="list-disc marker:text-custom-primary-200">
                <p className="font-semibold text-base font-heading text-custom-text-100">
          ...
          <h2 className="font-heading text-xl mt-6">Intrinsic Qualities:</h2>
          <p className="text-custom-text-200 font-paragraph tracking text-base pt-1">
          ...
          <h2 className="font-heading text-xl mt-6">Future Aspirations:</h2>
          <p className="text-custom-text-200 font-paragraph tracking text-base pt-1">
          ...
          <p className="text-custom-text-200 font-paragraph tracking text-base">
